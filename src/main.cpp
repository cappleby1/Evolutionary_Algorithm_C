...
void menu() {
    ...
    if (image == "8a.png") {
        ...
        menu();  // Recursively call menu if image is invalid
        return;  // Avoid executing further code in this function
    }

    load_image(image_path, target_width, target_height, target_channels, target_image_data);
}
